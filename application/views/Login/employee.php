            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row"><span class="error"><?php if(isset($error) && $result != '0'){
							echo $error." ".$result;
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $detail->mobile;?></td> 
                                                     <td><?php echo $detail->working_status;?></td>
                                                      <td><a href="<?php echo base_url() . 'index.php/Login/single/' . $id; ?>" title="view"><i class="zmdi zmdi-eye zmdi-hc-lg"></i></a>
                                                      <td><a href="<?php echo base_url() . 'index.php/Login/employee_edit/'. $id; ?>" title="edit"><i class="zmdi zmdi-edit zmdi-hc-lg"></i></a></td>
                                                      <td><a href="javascript:void(0)" title="delete" class="del_icn"><p style="display:none"><?php echo $id;?></p><i class="zmdi zmdi-delete zmdi-hc-lg"></i></a></td>
