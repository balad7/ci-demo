                ...
                <div class="navbar navbar-default" role="navigation">
                    <div class="container">
                        ...
                        <!-- Right(Notification and Searchbox --><?php
                         foreach($salary_single as $detail){
                                          $id = $detail->salary_id; 
								}?>
                        ...
                        <li>
                                ...
                                <div class="notification-box">
                                    <ul class="list-inline m-b-0">
                                        ...
                                        <li><a href="<?php echo base_url() . 'index.php/Salary/salary_edit/'. $id; ?>" title="edit"><i class="zmdi zmdi-edit"></i></a>
										 ...
										 foreach($salary_single as $detail){?> 
                                             <tr>
                                              ...
                                              <tr>
                                               ...
                                               <tr>
                                                	<th>Basic Salary</th>
                                                    <td><?php echo $detail->basic_salary;?></td>
                                               </tr>
                                               <tr>
                                                 	<th>HRA</th>
                                                    <td><?php echo $detail->hra;?></td>
                                               </tr>
                                               <tr>  
                                            		<th>Bonus</th>    
                                                    <td ><?php echo $detail->bonus;?></td>
                                               </tr>
                                               <tr>
                                                    <th>Deduction</th>
                                                    <td ><?php echo $detail->deduction;?></td>
                                               </tr>                                                 
                                               <tr>
                                                    <th>Total Salary</th>
