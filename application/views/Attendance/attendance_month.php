                ...
                <div class="navbar navbar-default" role="navigation">
                    <div class="container">
                        ...
                        <ul class="nav navbar-nav navbar-left">
                            ...
                            </li><?php foreach($attendance_details as $detail){
											 $year = $detail->attendance_year;
											 }?>
                            <li>
                                <h4 class="page-title">Year: <?php echo  $year;?></h4>
                            </li>
                        </ul>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <thead>
										 ...
										 foreach($attendance_details as $detail){
											 ...
											 $year = $detail->attendance_year;?>
                                                <tr>
                                                     <?php if($month == "1"){?><td><a href="<?php echo base_url() . 'index.php/Attendance/single/'.$year.'/'.$month; ?>">January</a></td><?php } ?>
                                                     <?php if($month == "2"){?><td><a href="<?php echo base_url() . 'index.php/Attendance/single/'.$year.'/'.$month; ?>">February </a></td><?php } ?>
                                                     <?php if($month == "3"){?><td><a href="<?php echo base_url() . 'index.php/Attendance/single/'.$year.'/'.$month; ?>">March</a></td><?php } ?>
                                                     <?php if($month == "4"){?><td><a href="<?php echo base_url() . 'index.php/Attendance/single/'.$year.'/'.$month; ?>">April</a></td><?php } ?>
                                                     <?php if($month == "5"){?><td><a href="<?php echo base_url() . 'index.php/Attendance/single/'.$year.'/'.$month; ?>">May</a></td><?php } ?>
                                                     <?php if($month == "6"){?><td><a href="<?php echo base_url() . 'index.php/Attendance/single/'.$year.'/'.$month; ?>">June</a></td><?php } ?>
                                                     <?php if($month == "7"){?><td><a href="<?php echo base_url() . 'index.php/Attendance/single/'.$year.'/'.$month; ?>">July</a></td><?php } ?>
                                                     <?php if($month == "8"){?><td><a href="<?php echo base_url() . 'index.php/Attendance/single/'.$year.'/'.$month; ?>">August</a></td><?php } ?>
                                                     <?php if($month == "9"){?><td><a href="<?php echo base_url() . 'index.php/Attendance/single/'.$year.'/'.$month; ?>">September</a></td><?php } ?>
                                                     <?php if($month == "10"){?><td><a href="<?php echo base_url() . 'index.php/Attendance/single/'.$year.'/'.$month; ?>">October</a></td><?php } ?>
                                                     <?php if($month == "11"){?><td><a href="<?php echo base_url() . 'index.php/Attendance/single/'.$year.'/'.$month; ?>">November</a></td><?php } ?>
                                                     <?php if($month == "12"){?><td><a href="<?php echo base_url() . 'index.php/Attendance/single/'.$year.'/'.$month; ?>">December</a></td><?php } ?>
                                                      <td><a href="<?php echo base_url() . 'index.php/Attendance/single/'.$year.'/'.$month; ?>" title="view"><i class="zmdi zmdi-eye zmdi-hc-lg"></i></a></td>
                                                      <td><a href="<?php echo base_url() . 'index.php/Attendance/attendance_edit/'.$year.'/'.$month; ?>" title="edit"><i class="zmdi zmdi-edit zmdi-hc-lg"></i></a></td>
                                                </tr>
                                                <?php $i++;}
										 }?>
                                            </tbody>
