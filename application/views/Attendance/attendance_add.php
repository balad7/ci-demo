    <body class="fixed-left">
        ...
        <div id="wrapper">
            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        <div class="row"><span class="error"><?php
						if(isset($error) && $result != '0'){
							...
							<?php $attributes = array('name' => 'attendance_insert', 'id' => 'attendance_insert');?> 
                             <span class="error"><?php echo validation_errors(); ?></span><?php 
						     echo form_open('attendance-add', $attributes); ?>
                             <div class="month_year_overall">
                                ...
                                <div class="form-group">
                                      ...
                                      <div class="working_days_div">
                                           <input type="text" name="wking_days" parsley-trigger="change" placeholder="No of working days of this month" class="form-control" id="wking_days" min="0" required>
                                      </div>     
                                ...
                                <table class="attendance_table">
                                     <tr>
                                      ...
                                      <tr>
                                            <td><input type="text" name="emp_name[en][]" parsley-trigger="change" class="form-control" id="emp_name" value="<?php echo $detail->employee_name.'('.$detail->employee_number.')';?>" readonly>
                                            <input type="hidden" name="emp_id[id][]" id="emp_id" value="<?php echo $detail->s_no;?>"></td>
                                            <td><input type="text" name="cl[cl][]" parsley-trigger="change" placeholder="No of CL's" class="form-control" id="cl" min="0" required></td>
                                            <td><input type="text" name="unpaid_leaves[ul][]" parsley-trigger="change" placeholder="Enter no of unpaid leaves" class="form-control" id="unpaid_leaves" min="0" required></td>
                                            <td><input type="text" name="permission[pm][]" parsley-trigger="change" placeholder="Permission(Hrs)" class="form-control" id="permission" min="0" required></td>
                                      </tr><?php }
									  }?>
