								...
								echo $error;
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <thead>
                                         ...
                                         <tbody><?php 
										 $i=1;
										 if(isset($attendance_search)){
											 //print_r($attendance_search);
											 if($attendance_search == "0 Results"){?>
												  <span class="error">0 Results found!</span><?php
												 }else{
											 //print_r($attendance_search);		
											 for($i = 0; $i < count($attendance_search["result"]); $i++){
												 $year= $attendance_search["result"][$i]["attendance_year"];
											     $months= $attendance_search["result"][$i]["attendance_month"];
												 if($months == "1"){
													 $month = "January";
													}elseif($months == "2"){
														 $month = "February";
													...
													?>
                                                <tr>
                                                     <td><a href="<?php echo base_url() . 'index.php/Attendance/single/'.$year.'/'.$months; ?>"><?php echo $year."(". $month.")"; ?></a></td>
